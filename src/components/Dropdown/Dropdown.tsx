  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <div>
        <button
          type="button"
          className="inline-flex w-full items-center justify-center rounded-md bg-gray-100 py-2 pl-4 pr-3 text-sm font-semibold text-gray-800 transition-all hover:bg-gray-200"
          id="menu-button"
          aria-expanded="true"
          aria-haspopup="true"
