...
DB_CONTAINER_NAME="dish-rental-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=dish-rental -d -p 5432:5432 docker.io/postgres
